  ...
  return (
    <div className="pt-20 pb-16 min-h-screen bg-neutral-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Breadcrumb */}
        <nav className="flex items-center gap-2 text-sm text-neutral-500 mt-6 mb-6">
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-between">
              <div>
                ...
                {product.description && (
                  <p className="text-neutral-600 leading-relaxed mb-8 text-base">{product.description}</p>
                )}
                  ...
                  {[
                    ...
                    <div key={text} className="flex items-center gap-3 text-sm text-neutral-600">
                      <div className="w-8 h-8 rounded-lg bg-rose-50 flex items-center justify-center flex-shrink-0">
                        <svg className="w-4 h-4 text-rose-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d={icon} /></svg>
                      </div>
                      {text}
                    </div>
                  ))}
